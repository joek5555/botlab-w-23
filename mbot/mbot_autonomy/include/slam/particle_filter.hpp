...
private:
    ...
    double percent_of_top_particles = 0.5;
    //double covariance_of_sampled_particles_xy = 0.2;
    double covariance_of_sampled_particles_xy = 0.05;
    ...
    double covariance_of_sampled_particles_theta = 0.1; // 99 percent of particles are within 45 degrees left or right of best particle
